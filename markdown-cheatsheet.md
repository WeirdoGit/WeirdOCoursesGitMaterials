...
**Visit <a href="https://github.com/weirdocourses">WeirdOCourses's GitHub Profile</a>.**
...
Please let me know if you find typos, grammar or spelling mistakes, or have a suggestion for improving the cheatsheet (since GitHub does not send notifications for gists, it might be better to contact me on twitter, at [@weirdocourses](https://twitter.com/weirdocourses)).
